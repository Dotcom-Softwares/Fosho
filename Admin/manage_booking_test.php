        ...
        <form name="truckEntry" action="submit-truck.php" method="post">
          <div class="block-fluid">
            ...
            <div class="row-form clearfix">
              ...
              <div class="span9">
                <input type="text" name="distance" id="distance" value="0">
              </div>
            </div>
            <div class="row-form clearfix">
              <div class="span3"> Rate Per km:</div>
              <div class="span9">
              	<input type="text" name="km_rate" id="km_rate" value="0">
              </div>
            </div>
            <div class="row-form clearfix">
              <div class="span3"> Estimated Frieght:</div>
              <div class="span9">
                <input type="text" name="fare" id="fare" value="0">
              </div>
            </div>
            <div class="row-form clearfix">
              <div class="span4">

...
--
-- Host: localhost
-- Generation Time: Feb 11, 2016 at 11:45 AM
...
(1, 'azharislam21@gmail.com', 'Admin', 'admin');
...
CREATE TABLE IF NOT EXISTS `booking` (
  ...
  `truck_ids` varchar(50) NOT NULL,
  `truck_type` varchar(50) NOT NULL,
  `total_truck` varchar(50) NOT NULL,
  `booking_date` varchar(50) NOT NULL,
  `pickup_date` varchar(50) NOT NULL,
  `app_distance` varchar(50) NOT NULL,
  `estimate_cost` varchar(50) NOT NULL,
  `pickup_latlong` varchar(50) NOT NULL,
  `unload_latlong` varchar(50) NOT NULL,
  `pickup_time` varchar(50) NOT NULL,
  `loading_time` varchar(50) NOT NULL,
  `unloading_time` varchar(50) NOT NULL,
  `total_distance` varchar(50) NOT NULL,
  `total_cost` varchar(50) NOT NULL,
  `xtra_cost` varchar(50) NOT NULL,
...
INSERT INTO `booking` (`booking_id`, `booking_type`, `cid`, `pickup_city`, `destination_city`, `cargo_type`, `cargo_weight`, `truck_ids`, `truck_type`, `total_truck`, `booking_date`, `pickup_date`, `app_distance`, `estimate_cost`, `pickup_latlong`, `unload_latlong`, `pickup_time`, `loading_time`, `unloading_time`, `total_distance`, `total_cost`, `xtra_cost`, `paid_amount`, `current_status`) VALUES
(1, '', '', 'Midnapore, West Bengal, India', 'Kolkata, West Bengal, India', '4', '50', '', '1', '5', '', '10-11-2016', '130 ', '780000', '', '', '', '', '', '', '', '', '', 'confirm'),
(2, '', '', 'Midnapore, West Bengal, India', 'Kharagpur, West Bengal, India', 'choose a option...', '60', '', '1', '5', '', '10-11-2016', '24.4 ', '146400', '', '', '', '', '', '', '', '', '', 'confirm'),
(3, '', '', 'Midnapore, West Bengal, India', 'Kolkata, West Bengal, India', '5', '60', '', '1', '50', '', '145544', '130 ', '780000', '', '', '', '', '', '', '', '', '', 'confirm');
...
INSERT INTO `cargo_type` (`id`, `type`) VALUES
(4, 'azhar'),
(5, 'vjdbfjgvhb'),
(6, 'fdssdf'),
(7, '11111111'),
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `password` varchar(50) NOT NULL,
  `email` varchar(50) NOT NULL,
  `em_name1` varchar(50) NOT NULL,
  `em_no1` varchar(50) NOT NULL,
  `em_name2` varchar(50) NOT NULL,
  `em_no2` varchar(50) NOT NULL,
  `em_name3` varchar(50) NOT NULL,
  `em_no3` varchar(50) NOT NULL,
...
INSERT INTO `customer` (`cid`, `name`, `pan_no`, `phone`, `mobile`, `address`, `password`, `email`, `em_name1`, `em_no1`, `em_name2`, `em_no2`, `em_name3`, `em_no3`, `status`) VALUES
(8, 'kgkgkg', 'kgkgkg', 'kjgkgkg', 'kgkgkg', 'kjgkgkPlease Input Address.....', 'kjkgkg', 'kgkgkg', '', '', '', '', '', '', 1);
...
INSERT INTO `price` (`id`, `rate`, `unit`) VALUES
(1, '500', 'mile');
...
CREATE TABLE IF NOT EXISTS `trucks` (
  ...
  `owner_contact_no` varchar(50) NOT NULL,
...
INSERT INTO `trucks` (`id`, `number`, `owner_name`, `owner_contact_no`, `driver_name`, `driver_contact_no`, `status`, `running_status`, `truck_type`, `max_weight`) VALUES
(1, 'khkjl', 'jklil', '', '', '', '1', 'Available', 'choose a option...', '');

-- --------------------------------------------------------

--
-- Table structure for table `truck_current_position`
--

CREATE TABLE IF NOT EXISTS `truck_current_position` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `truck_type` (`id`, `type`, `max_weight`, `rate`) VALUES
(1, 'fgjghhg', '50', '6000'),
(11, 'ghfgkjfhg', '50', '20'),
(12, 'hgfghkj', '50', '5000'),
(13, 'fghfhg', '50', '6000'),
...
--
-- Table structure for table `userlog_details`
--

CREATE TABLE IF NOT EXISTS `userlog_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `userlog_details`
--

INSERT INTO `userlog_details` (`id`, `user`, `date`, `time`, `action`) VALUES
(1, 'Admin', '2016-01-30', '16:53:07', 'Insert Customer Id 1'),
(2, 'Admin', '2016-01-30', '17:01:14', 'Admin Login'),
(3, 'Admin', '2016-01-31', '11:59:34', 'Admin Login'),
(4, 'Admin', '2016-01-31', '12:22:52', 'Admin Login'),
(5, 'Admin', '2016-01-31', '15:21:35', 'Admin Login'),
(6, 'Admin', '2016-01-31', '15:30:23', 'Admin Login'),
(7, 'Admin', '2016-01-31', '18:38:48', 'Admin Login'),
(8, 'Admin', '2016-02-01', '09:57:28', 'Admin Login'),
(9, 'Admin', '2016-02-01', '19:39:30', 'Admin Login'),
(10, 'Admin', '2016-02-01', '20:13:38', 'Insert Customer Id 2'),
(11, 'Admin', '2016-02-02', '11:15:22', 'Admin Login'),
(12, 'Admin', '2016-02-02', '21:05:24', 'Admin Login'),
(13, 'Admin', '2016-02-03', '15:04:23', 'Admin Login'),
(14, 'Admin', '2016-02-03', '22:57:51', 'Admin Login'),
(15, 'Admin', '2016-02-04', '13:43:28', 'Admin Login'),
(16, 'Admin', '2016-02-04', '13:51:58', 'Admin Login'),
(17, '', '2016-02-04', '14:01:48', 'Insert Booking Id 2'),
(18, '', '2016-02-04', '14:03:22', 'Insert Booking Id 1'),
(19, '', '2016-02-04', '14:06:28', 'Insert Booking Id 2'),
(20, '', '2016-02-04', '14:08:25', 'Insert Booking Id 3'),
(21, '', '2016-02-04', '14:11:05', 'Insert Customer Id 3'),
(22, 'Admin', '2016-02-04', '14:13:14', 'Admin Login'),
(23, 'Admin', '2016-02-04', '14:16:10', 'Insert Customer Id 4'),
(24, 'Admin', '2016-02-04', '14:18:20', 'Insert Booking Id 4'),
(25, 'Admin', '2016-02-04', '16:28:46', 'Admin Login'),
(26, 'Admin', '2016-02-04', '17:28:18', 'Admin Login'),
(27, 'Admin', '2016-02-04', '19:44:26', 'Admin Login'),
(28, 'Admin', '2016-02-04', '19:45:11', 'Admin Login'),
(29, 'Admin', '2016-02-04', '19:50:08', 'Admin Login'),
(30, 'Admin', '2016-02-04', '19:57:38', 'Admin Login'),
(31, 'Admin', '2016-02-05', '07:41:15', 'Admin Login'),
(32, 'Admin', '2016-02-05', '14:04:44', 'Admin Login'),
(33, 'Admin', '2016-02-05', '14:22:19', 'Admin Login'),
(34, 'Admin', '2016-02-05', '14:22:54', 'Admin Login'),
(35, 'Admin', '2016-02-05', '14:24:37', 'Admin Login'),
(36, 'Admin', '2016-02-05', '20:06:28', 'Admin Login'),
(37, 'Admin', '2016-02-07', '13:32:12', 'Admin Login'),
(38, 'Admin', '2016-02-07', '13:43:25', 'Admin Login'),
(39, 'Admin', '2016-02-07', '13:46:31', 'Admin Login'),
(40, 'Admin', '2016-02-07', '19:15:36', 'Admin Login'),
(41, 'Admin', '2016-02-07', '19:47:29', 'Logout Admin'),
(42, 'Admin', '2016-02-07', '19:47:32', 'Admin Login'),
(43, 'Admin', '2016-02-07', '19:48:41', 'Logout Admin'),
(44, 'Admin', '2016-02-07', '19:48:43', 'Admin Login'),
(45, 'Admin', '2016-02-07', '19:48:43', 'Logout Admin'),
(46, 'Admin', '2016-02-07', '19:48:46', 'Admin Login'),
(47, 'Admin', '2016-02-07', '19:48:46', 'Logout Admin'),
(48, 'Admin', '2016-02-07', '19:48:47', 'Admin Login'),
(49, 'Admin', '2016-02-07', '19:48:47', 'Logout Admin'),
(50, 'Admin', '2016-02-07', '19:48:48', 'Admin Login'),
(51, 'Admin', '2016-02-07', '19:48:49', 'Logout Admin'),
(52, 'Admin', '2016-02-07', '19:49:43', 'Admin Login'),
(53, 'Admin', '2016-02-07', '19:49:43', 'Logout Admin'),
(54, 'Admin', '2016-02-07', '19:49:45', 'Admin Login'),
(55, 'Admin', '2016-02-07', '19:49:45', 'Logout Admin'),
(56, 'Admin', '2016-02-07', '19:50:25', 'Admin Login'),
(57, 'Admin', '2016-02-07', '19:50:25', 'Logout Admin'),
(58, 'Admin', '2016-02-07', '19:50:48', 'Admin Login'),
(59, 'Admin', '2016-02-07', '19:53:08', 'Logout Admin'),
(60, 'Admin', '2016-02-07', '19:54:06', 'Admin Login'),
(61, 'Admin', '2016-02-07', '19:54:07', 'Logout Admin'),
(62, 'Admin', '2016-02-07', '19:56:37', 'Admin Login'),
(63, 'Admin', '2016-02-07', '19:56:37', 'Logout Admin'),
(64, 'Admin', '2016-02-08', '07:51:34', 'Admin Login'),
(65, 'Admin', '2016-02-08', '07:51:34', 'Logout Admin'),
(66, 'Admin', '2016-02-08', '07:51:41', 'Admin Login'),
(67, 'Admin', '2016-02-08', '07:51:41', 'Logout Admin'),
(68, 'Admin', '2016-02-08', '07:52:43', 'Admin Login'),
(69, 'Admin', '2016-02-08', '07:52:43', 'Logout Admin'),
(70, 'Admin', '2016-02-08', '07:53:04', 'Admin Login'),
(71, 'Admin', '2016-02-08', '07:53:04', 'Logout Admin'),
(72, 'Admin', '2016-02-08', '07:53:46', 'Admin Login'),
(73, 'Admin', '2016-02-08', '07:53:46', 'Logout Admin'),
(74, 'Admin', '2016-02-08', '07:56:16', 'Admin Login'),
(75, 'Admin', '2016-02-08', '07:56:16', 'Logout Admin'),
(76, '', '2016-02-08', '07:57:30', 'Logout '),
(77, '', '2016-02-08', '07:58:35', 'Logout '),
(78, '', '2016-02-08', '07:58:51', 'Logout '),
(79, 'Admin', '2016-02-08', '08:16:39', 'Admin Login'),
(80, 'Admin', '2016-02-08', '08:16:39', 'Logout Admin'),
(81, 'Admin', '2016-02-08', '08:22:27', 'Admin Login'),
(82, 'Admin', '2016-02-08', '08:22:44', 'Logout Admin'),
(83, 'Admin', '2016-02-08', '08:22:52', 'Admin Login'),
(84, 'Admin', '2016-02-08', '08:22:52', 'Logout Admin'),
(85, 'Admin', '2016-02-08', '08:23:48', 'Admin Login'),
(86, 'Admin', '2016-02-08', '08:24:49', 'Logout Admin'),
(87, 'Admin', '2016-02-08', '08:24:56', 'Admin Login'),
(88, 'Admin', '2016-02-08', '08:24:56', 'Logout Admin'),
(89, 'Admin', '2016-02-08', '08:28:52', 'Admin Login'),
(90, 'Admin', '2016-02-08', '08:30:16', 'Logout Admin'),
(91, 'Admin', '2016-02-08', '11:08:20', 'Admin Login'),
(92, 'Admin', '2016-02-08', '11:08:20', 'Logout Admin'),
(93, 'Admin', '2016-02-08', '11:31:18', 'Admin Login'),
(94, 'Admin', '2016-02-08', '11:31:18', 'Logout Admin'),
(95, 'Admin', '2016-02-08', '11:34:19', 'Admin Login'),
(96, 'Admin', '2016-02-08', '11:34:19', 'Logout Admin'),
(97, 'Admin', '2016-02-08', '11:34:51', 'Admin Login'),
(98, 'Admin', '2016-02-08', '11:34:51', 'Logout Admin'),
(99, 'Admin', '2016-02-08', '12:05:19', 'Admin Login'),
(100, 'Admin', '2016-02-08', '12:05:21', 'Logout Admin'),
(101, 'Admin', '2016-02-08', '12:17:47', 'Admin Login'),
(102, 'Admin', '2016-02-08', '12:30:52', 'Admin Login'),
(103, 'Admin', '2016-02-08', '12:34:24', 'Admin Login'),
(104, 'Admin', '2016-02-08', '12:34:53', 'Admin Login'),
(105, 'Admin', '2016-02-08', '14:03:18', 'Admin Login'),
(106, 'Admin', '2016-02-08', '14:10:10', 'Insert Booking Id 5'),
(107, 'Admin', '2016-02-08', '14:20:36', 'Admin Login'),
(108, 'Admin', '2016-02-08', '14:27:18', 'Admin Login'),
(109, 'Admin', '2016-02-08', '14:28:08', 'Admin Login'),
(110, 'Admin', '2016-02-08', '14:37:57', 'Admin Login'),
(111, 'Admin', '2016-02-08', '14:55:46', 'Admin Login'),
(112, 'Admin', '2016-02-08', '15:43:39', 'Insert Customer Id 5'),
(113, 'Admin', '2016-02-08', '15:44:36', 'Insert Customer Id 6'),
(114, 'Admin', '2016-02-08', '15:45:39', 'Insert Customer Id 7'),
(115, 'Admin', '2016-02-08', '15:59:44', 'Insert Customer Id 8'),
(116, 'Admin', '2016-02-08', '16:21:01', 'Admin Login'),
(117, 'Admin', '2016-02-08', '16:50:05', 'Admin Login'),
(118, 'Admin', '2016-02-08', '17:07:14', 'Admin Login'),
(119, 'Admin', '2016-02-08', '17:29:48', 'Admin Login'),
(120, 'Admin', '2016-02-08', '17:37:01', 'Admin Login'),
(121, 'Admin', '2016-02-08', '17:37:49', 'Admin Login'),
(122, 'Admin', '2016-02-09', '11:30:07', 'Admin Login'),
(123, 'Admin', '2016-02-09', '11:57:10', 'Insert Booking Id 6'),
(124, 'Admin', '2016-02-09', '12:01:45', 'Admin Login'),
(125, 'Admin', '2016-02-09', '12:40:18', 'Admin Login'),
(126, 'Admin', '2016-02-09', '12:42:41', 'Admin Login'),
(127, 'Admin', '2016-02-09', '12:43:06', 'Admin Login'),
(128, 'Admin', '2016-02-09', '12:43:37', 'Admin Login'),
(129, 'Admin', '2016-02-09', '12:44:38', 'Admin Login'),
(130, 'Admin', '2016-02-09', '12:44:54', 'Admin Login'),
(131, 'Admin', '2016-02-09', '12:50:47', 'Insert Booking Id 7'),
(132, 'Admin', '2016-02-09', '12:58:46', 'Insert Booking Id 8'),
(133, 'Admin', '2016-02-09', '13:15:15', 'Admin Login'),
(134, 'Admin', '2016-02-09', '13:16:40', 'Admin Login'),
(135, 'Admin', '2016-02-09', '14:08:21', 'Insert Booking Id 9'),
(136, 'Admin', '2016-02-09', '14:40:58', 'Admin Login'),
(137, 'Admin', '2016-02-10', '08:56:45', 'Admin Login'),
(138, 'Admin', '2016-02-10', '13:15:47', 'Admin Login'),
(139, 'Admin', '2016-02-10', '14:23:25', 'Insert Booking Id 10'),
(140, 'Admin', '2016-02-10', '14:47:14', 'Insert Booking Id 1'),
(141, 'Admin', '2016-02-10', '14:57:02', 'Admin Login'),
(142, 'Admin', '2016-02-10', '15:19:32', 'Insert Booking Id 2'),
(143, 'Admin', '2016-02-10', '16:46:51', 'Admin Login'),
(144, 'Admin', '2016-02-10', '17:19:44', 'Admin Login'),
(145, 'Admin', '2016-02-10', '23:27:01', 'Admin Login'),
(146, 'Admin', '2016-02-11', '10:53:30', 'Admin Login'),
(147, 'Admin', '2016-02-11', '11:18:18', 'Admin Login'),
(148, 'Admin', '2016-02-11', '11:58:05', 'Admin Login'),
(149, 'Admin', '2016-02-11', '11:58:31', 'Admin Login'),
(150, 'Admin', '2016-02-11', '12:03:35', 'Admin Login'),
(151, 'Admin', '2016-02-11', '12:06:06', 'Admin Login'),
(152, 'Admin', '2016-02-11', '16:07:43', 'Confirm Booking Id 0'),
(153, 'Admin', '2016-02-11', '16:35:05', 'Insert Booking Id 2'),
(154, 'Admin', '2016-02-11', '16:38:10', 'Confirm Booking Id 0'),
(155, 'Admin', '2016-02-11', '16:38:37', 'Insert Booking Id 3'),
(156, 'Admin', '2016-02-11', '16:38:59', 'Confirm Booking Id 0');
...
CREATE TABLE IF NOT EXISTS `user_login` (
  ...
  `logintime_from` varchar(50) NOT NULL,
  `logintime_to` varchar(50) NOT NULL,
  `status` varchar(50) NOT NULL,
  PRIMARY KEY (`uid`)
...
INSERT INTO `user_login` (`uid`, `name`, `user_email`, `userPhone`, `username`, `password`, `usertype`, `logintime_from`, `logintime_to`, `status`) VALUES
(1, '1', '1@1', '11 (111) 111-11-11', '1', '11111', 'admin', '', '', '0'),
(2, '2', '2@2', '22 (222) 222-22-22', '2', '22222', 'admin', '', '', '0'),
(3, '3', '3@3', '33 (333) 333-33-33', '3', '333333', 'admin', '', '', '0'),
(4, '4', '4@4', '44 (444) 444-44-44', '4', '44444', 'admin', '', '', '0'),
(5, '5', '5@5', '55 (555) 555-55-55', '5', '555  555', 'admin', '', '', '0'),
(6, '6', '6@6', '66 (666) 666-66-66', '6', '6666666', 'admin', '', '', '0'),
(7, '7', '7@7', '77 (777) 777-77-77', '7', '7777777', 'admin', '', '', '0'),
(8, '8', '8@8', '88 (888) 888-88-88', '8', '888888888', 'admin', '', '', '0'),
(9, '9', '9@9', '99 (999) 999-99-99', '9', '9999999', 'callcenter', '', '', '0'),
(10, '10', '10@10', '10 (101) 010-10-10', '10', '1000000', 'admin', '', '', '0'),
(11, '11', '11@11', '12 (121) 222-12-21', '11', '111111111', 'admin', '', '', '0'),
(12, '12', '12@12', '12 (123) 121-21-21', '12', '1212121212', 'callcenter', '', '', '0');
...
CREATE TABLE IF NOT EXISTS `wallet` (
  ...
  `estimateRate` varchar(50) NOT NULL,

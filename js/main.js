...
;(function(window) {
	...
	var bodyEl = document.body, 
		...
		scrollContainer = document.querySelector('.pop-container'),
...
/*Support*/
$(document).on('click', '.question-heading span.clickable', function(e){
    var $this = $(this);
	if(!$this.hasClass('panel-collapsed')) {
		...
		$this.parents('.panel').find('.question-body').slideDown();
